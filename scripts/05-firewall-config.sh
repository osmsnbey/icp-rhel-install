...
MASTER_PORTS=("111" "2049" "8101" "179" "8500" "8743" "5044" "5046" "9200" "9300" "2380" "4001" "8082" "8084" "4500" "4300" "8600" "80" "443" "8181" "18080" "5000" "35357" "4194" "10248:10252" "30000:32767" "8001" "8888" "8080" "8443" "9235" "9443")
WORKER_PORTS=("111" "2049" "179" "4300" "4194" "10248:10252" "30000:32767" "8001" "8888")
# Stop firewall
...
for ((i=1; i < $NUM_MANAGE; i++)); do
  ...
  ssh ${SSH_USER}@${MANAGE_HOSTNAMES[i]} sudo systemctl stop firewalld.service
  for port in "${MANAGE_PORTS[@]}"; do
    ssh ${SSH_USER}@${MANAGE_HOSTNAMES[i]} sudo iptables -A INPUT -p tcp -m tcp --sport $port -j ACCEPT
    ssh ${SSH_USER}@${MANAGE_HOSTNAMES[i]} sudo iptables -A OUTPUT -p tcp -m tcp --dport $port -j ACCEPT
  done

  # Do we need this?
  ssh ${SSH_USER}@${MANAGE_HOSTNAMES[i]} sudo service iptables restart
done